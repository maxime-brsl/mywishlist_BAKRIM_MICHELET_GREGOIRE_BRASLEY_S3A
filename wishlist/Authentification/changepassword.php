...
if (isset($_REQUEST['ancienpassword'], $_REQUEST['nouveaupassword'])){
        ...
        if ($usr->password === hash('sha256',$apwd)) {
            if ($npwd === $pwdv) {
                ...
                header("Location: http://localhost/wishlist/Authentification/logout.php");
            } else {
...
<form class="box" action="" method="post">
    <h1 class="box-logo box-title"><a href="/wishlist/utilisateurs/<?php echo $_SESSION['username'] ?>">WishList</a></h1>
